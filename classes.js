...
class Training {
  constructor(pushUps, crunch, pullUps){
      this.pushUps = pushUps;
      this.crunch = crunch;
      this.pullUps = pullUps;
  }
}
let warmUp = new Training(15,20,10);

class LegDay extends Training{
  constructor(crunch, squat, legPress, legCurl){
      super(0, crunch, 0, squat, legPress, legCurl);
      
      this.squat = squat;
      this.legPress = legPress;
      this.legCurl = legCurl;
  }
}

let legDay = new LegDay(10,"4x5","3x15","3x15");


Training.prototype.howManyPushUps = function() {
